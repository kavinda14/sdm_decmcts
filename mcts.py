...
def mcts( action_set, budget, max_iterations, exploration_exploitation_parameter, robot, map):
    ...
    for iter in range(max_iterations):
        ...
        # Rollout
        print("Rollout Phase")
        rollout_sequence = rollout(subsequence=current.sequence, action_set=action_set, robot=robot, map=map, budget=budget)
        rollout_reward = reward(action_sequence=rollout_sequence, robot=robot, map=map)
